            ...
            <div class="card-body">
               <div class="table-responsive">
                  <table id="datatable" class="table table-striped" data-toggle="data-table">
                     ...
                     <tbody>
                     <?php $no=1; ?>
                        @foreach($infrastruktur as $infrastruktur)
                        <tr>
                            <td>{{$no++}}</td>
                            <td>{{$infrastruktur->nama_infrastruktur}}</td>
                            <td>{{ $infrastruktur->link_infrastruktur }}</td>
                            <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip"
                                                            data-placement="top" title="" data-original-title="Edit"
                                                            href="/infrastruktur/{{$infrastruktur->id}}/editinfrastruktur">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="/dokumentasi/{{$infrastruktur->id}}/delete" onclick="return confirm('Yakin ingin menghapus?')">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="/landingpage/dasarhukum/createdasarhukum" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="mb-3">
