                            ...
                            <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="/agenda/{{$agenda->id}}/delete" onclick="return confirm('Yakin ingin menghapus?')">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="/agenda/create" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="mb-3">
                        ...
                        <select name="jenisagenda_id" class="form-select" required aria-label=".form-select-sm example">
                            ...
                            <option value="{{$jenisagenda->id}}">{{$jenisagenda->nama_jenis}}</option>
                            @endforeach
                        </select>
                        
                        <label class="form-label">Nama Acara</label>
                        <input type="text" name="nama_acara" class="form-control @error('nama_acara') is-invalid @enderror" required value="{{ old('nama_acara')}}">
                        @error('nama_acara')
                        ...
                        <label>Perihal</label>
                        <input name="perihal" class="form-control @error('perihal') is-invalid @enderror">
                        ...
                        <label>Tanggal</label>
                        <input type="date" name="tanggal_acara" class="form-control @error('tanggal_acara') is-invalid @enderror">
                        <div class="text-danger">
                            @error('tanggal_acara')
                                    {{ $message }}
                            @enderror 
                        ...
                        <label>Waktu</label>
                        <input type="time" name="waktu_acara" class="form-control @error('waktu_acara') is-invalid @enderror">
                        <div class="text-danger">
                            @error('waktu_acara')
                                    {{ $message }}
                            @enderror 
                        ...
                        <input type="file" name="surat" class="form-control @error('surat') is-invalid @enderror" required>
                        @error('surat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
