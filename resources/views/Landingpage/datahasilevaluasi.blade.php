            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Data Hasil Evaluasi</h4>
                    </div>
                    <div class="right">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                @foreach ($hasilevaluasi as $dh)
                                    <tr>
                                        <td>{{ $no++ }}.</td>
                                        <td>{{ $dh->nama_hasilevaluasi }}</td>
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip"
                                                    data-placement="top" title="" data-original-title="Edit"
                                                    href="/datahasilevaluasi/{{ $dh->id }}/edit">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                    ...
                                                    href="/datahasilevaluasi/{{ $dh->id }}/delete"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="/datahasilevaluasi/create" method="POST">
                        {{ csrf_field() }}
                        <div class="mb-3">
