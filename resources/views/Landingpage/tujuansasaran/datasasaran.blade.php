                            ...
                            <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip"
                                                            ...
                                                            href="/landingpage/tujuansasaran/{{$sasaran->id}}/editsasaran">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="/dokumentasi/{{$sasaran->id}}/delete" onclick="return confirm('Yakin ingin menghapus?')">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="/landingpage/createsasaran" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="mb-3">
