                    ...
                    <div class="table-responsive">
                        <form action="/indikator/{{ $indikator->id }}/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="aspek_id" class="form-select" required
                                ...
                                <input type="number" name="no_indikator" value="{{ $indikator->no_indikator }}"
                                    class="form-control @error('no_indikator') is-invalid @enderror" required
                                ...
                                <input type="text" name="penjelasan_indikator"
                                    value="{{ $indikator->penjelasan_indikator }}"
                                    class="form-control @error('penjelasan_indikator') is-invalid @enderror" required
                                    value="{{ old('penjelasan_indikator') }}">
