                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-pertanyaan-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="/pertanyaanumum/{{$pertanyaan->id}}/delete" onclick="return confirm('Yakin ingin menghapus?')">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
            ...
            <div class="modal-body">
                ...
                {{csrf_field()}}
                    <div class="mb-3">
                        ...
                        <textarea name="soal" class="form-control @error('soal') is-invalid @enderror" rows="5"></textarea>
                        @error('soal')
