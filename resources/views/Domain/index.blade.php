            ...
            <div class="modal-body">
                ...
                {{csrf_field()}}
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_domain" class="form-control @error('nama_domain') is-invalid @enderror" required value="{{ old('nama_domain')}}">
                        @error('nama_domain')
                        ...
                        <input type="number" name="bobot_domain" class="form-control @error('bobot_domain') is-invalid @enderror" required value="{{ old('bobot_domain')}}">
                        @error('bobot_domain')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
