            ...
            <div class="modal-body">
                ...
                {{csrf_field()}}
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_aspek" class="form-control @error('nama_aspek') is-invalid @enderror" required value="{{ old('nama_aspek')}}">
                        @error('nama_aspek')
                        ...
                        <input type="number" name="bobot_aspek" class="form-control @error('bobot_aspek') is-invalid @enderror" required value="{{ old('bobot_aspek')}}">
                        @error('bobot_aspek')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
