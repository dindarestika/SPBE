                                                    ...
                                                    <div class="d-flex bd-highlight">
                                                        <div class="p-2 w-100 bd-highlight">
                                                            <div class="form-group">
                                                                <input type="hidden" name="id[]" class="form-control" value="{{$jwb->id}}">
                                                                <input type="hidden" name="pertanyaan_umum_id[]" class="form-control" value="{{$jwb->pertanyaan_umum_id}}">
                                                                <input type="hidden" name="user_id[]" class="form-control" value="{{auth()->user()->id}}">
                                                                <label for="Textarea" class="form-label">Jawaban:</label>
                                                                <textarea name="jawaban[]" class="form-control" id="Textarea" placeholder="Jawab di sini ..." rows="3">{{$jwb->jawaban}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>                                                   
                                            @endforeach
                                            ...
                                            <div class="pt-2">
                                                ...
                                                {{csrf_field()}}
                                                    <div class="d-flex bd-highlight">
                                                        <div class="p-2 w-100 bd-highlight">
                                                            <div class="form-group">
                                                                <input type="hidden" name="pertanyaan_umum_id[]" class="form-control" value="{{$pu->id}}">
                                                                <input type="hidden" name="user_id[]" class="form-control" value="{{auth()->user()->id}}">
                                                                <label for="Textarea" class="form-label">Jawaban:</label>
