        ...
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <!--logo End-->            <h4 class="logo-title">Evaluasi SPBE</h4>
            </a>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Tentang') ? 'active' : '' }}" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                    <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                            ...
                            <span class="item-name">Landingpage</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'visi') ? 'active' : '' }}" href="/datavisi">
                                    <i class="icon">
                                    ...
                                    <span class="item-name">Visi</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'misi') ? 'active' : '' }}" href="/datamisi">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> B </i>
                                    <span class="item-name">Misi</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'tujuan') ? 'active' : '' }}" href="/datatujuan">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Tujuan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'sasaran') ? 'active' : '' }}" href="/datasasaran">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'dasarhukum') ? 'active' : '' }}" href="/datadasarhukum">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Dasar Hukum</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'masterplan') ? 'active' : '' }}" href="/datamasterplan">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Master Plan E-Goverment</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'arsitektur') ? 'active' : '' }}" href="/pertanyaanumum">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Arsitektur SPBE</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'hasileva') ? 'active' : '' }}" href="/pertanyaan">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Hasil Evaluasi SPBE</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Evaluasi') ? 'active' : '' }}" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            ...
                            <span class="item-name">Evaluasi</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Evaluasi') ? 'active' : '' }}" href="/evaluasi">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> B </i>
                                    <span class="item-name">Data Evaluasi</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Domain') ? 'active' : '' }}" href="/domain">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> L </i>
                                    <span class="item-name">Data Domain</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Aspek') ? 'active' : '' }}" href="/aspek">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> R </i>
                                    <span class="item-name">Data Aspek</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Indikator') ? 'active' : '' }}" href="/indikator">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Data Indikator</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Pertanyaan Umum') ? 'active' : '' }}" href="/pertanyaanumum">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Pertanyaan Umum</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Pertanyaan') ? 'active' : '' }}" href="/pertanyaan">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Pertanyaan Mandiri</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'User') ? 'active' : '' }}" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'OPD') ? 'active' : '' }}" href="/opd">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Data OPD</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Role') ? 'active' : '' }}" href="/role">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> A </i>
                                    <span class="item-name">Data Role</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Agenda') ? 'active' : '' }}" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false" aria-controls="utilities-error">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Jenis Agenda') ? 'active' : '' }}" href="/jenisagenda">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Data Jenis Agenda</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Agenda') ? 'active' : '' }}" href="/agenda">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Data Agenda</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Dokumentasi') ? 'active' : '' }}" href="/dokumentasi">
                            <i class="icon">
                                 <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                            ...
                            <span class="item-name">Data Dokumentasi</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'TIK') ? 'active' : '' }}" data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'Wifi') ? 'active' : '' }}" href="/wifi">
                                  <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                  ...
                                  <i class="sidenav-mini-icon"> B </i>
                                  <span class="item-name">Data Wifi</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($title === 'infrastruktur') ? 'active' : '' }}" href="/datainfrastruktur">
                                  <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                  ...
                                  <i class="sidenav-mini-icon"> B </i>
                                  <span class="item-name">Infrastruktur</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Activity</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Penilaian') ? 'active' : '' }}" href="/penilaian">
                            ...
                            <span class="item-name">Penilaian</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === 'Agenda Admin') ? 'active' : '' }}" href="/calender">
							<i class="icon">
                                <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--
					<li class="nav-item">
                        <a class="nav-link {{ ($title === 'Dokumentasi Admin') ? 'active' : '' }}" href="#">
                            <i class="icon">
                                <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
