  ...
  <header id="header" class="d-flex align-items-center bgcolor">
    <div class="container d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        <a href="index.html"><!-- <img src="assets/img/spbe.png" alt=""> --></a>
      ...
      <div class="header-social-links d-flex align-items-center">
        <a href="https://youtube.com/channel/UCL-EOcz_vh_2OlIMIh3zkyg" class="youtube"><i class="bi bi-youtube"></i></a>
        <a href="https://twitter.com/PEMKOT_SOLO" class="twitter"><i class="bi bi-twitter"></i></a>
        <a href="https://instagram.com/pemkot_solo?utm_medium=copy_link" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="https://www.facebook.com/pemkotsolo/" class="facebook"><i class="bi bi-facebook"></i></i></a>
      </div>
    </div>
  </header><!-- End Header -->
