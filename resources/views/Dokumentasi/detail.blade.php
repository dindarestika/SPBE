                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th width="20px">:</th>
                            <th>
                                <a href="{{ asset('storage/' . $dokumentasi->notulen) }}" class="btn btn-primary">Lihat
                                    Notulen</a>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th width="20px">:</th>
                            <th>
                                <a href="{{ asset('storage/' . $dokumentasi->surat) }}" class="btn btn-primary">Lihat
                                    Surat</a>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th width="20px">:</th>
                            <th>
                                <a href="{{ asset('storage/' . $dokumentasi->presensi) }}" class="btn btn-primary">Lihat
                                    Presensi</a>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th width="20px">:</th>
                            <th>
                                <a href="{{ asset('storage/' . $dokumentasi->foto_acara) }}" class="btn btn-primary">Lihat
                                    Foto</a>
                            </th>
                        </tr>
                        <tr>
