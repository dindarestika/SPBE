                            ...
                            <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="/dokumentasi/{{$d->id}}/delete" onclick="return confirm('Yakin ingin menghapus?')">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
            ...
            <div class="modal-body">
                ...
                {{csrf_field()}}
                    <div class="mb-3">
                        ...
                        <input type="file" name="notulen" class="form-control @error('notulen') is-invalid @enderror" required>
                        @error('notulen')
                        ...
                        <input type="file" name="presensi" class="form-control @error('presensi') is-invalid @enderror" required>
                        @error('presensi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
