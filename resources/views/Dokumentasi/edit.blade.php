            ...
            <div class="card-body">
               ...
               <form action="/dokumentasi/{{$dokumentasi->id}}/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <object data="{{asset('storage/'.$dokumentasi->notulen)}}" alt="Notulen" width="900" height="800"></object>
                        <input type="file" name="notulen" value="{{$dokumentasi->notulen}}" class="form-control" >
                        @error('notulen')
                        ...
                        <object data="{{asset('storage/'.$dokumentasi->surat)}}" alt="Surat" width="900" height="800"></object>
                        ...
                        <object data="{{asset('storage/'.$dokumentasi->presensi)}}" alt="Presensi" width="900" height="800"></object>
                        <input type="file" name="presensi" value="{{$dokumentasi->presensi}}" class="form-control" >
                        @error('presensi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                        ...
                        <input type="file" name="foto_acara" value="{{$dokumentasi->foto_acara}}" class="form-control">
