            ...
            <div class="card-body">
               ...
               <form action="/user/{{$user->id}}/update" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_user" value="{{$user->nama_user}}" class="form-control @error('nama_user') is-invalid @enderror" required value="{{ old('nama_user')}}">
                                        @error('nama_user')
                                        ...
                                        <input type="email" name="email_user" value="{{$user->email_user}}" class="form-control @error('email_user') is-invalid @enderror" required value="{{ old('email_user')}}" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        @error('email_user')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <input type="text" name="username" value="{{$user->username}}" class="form-control @error('username') is-invalid @enderror" required value="{{ old('username')}}">
                                        @error('username')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <textarea name="alamat_user" class="form-control @error('alamat_user') is-invalid @enderror" required value="{{ old('alamat_user')}}" rows="2">{{$user->alamat_user}}</textarea>
                                        @error('alamat_user')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
