...
class PenilaianController extends Controller
{
    ...
    {
        // $data = DB::select("SELECT * FROM aspek")
    ...
    {
        $evaluasi = Evaluasi::find($id);
        $pertanyaan_umum = DB::select(
            "SELECT b.id, b.soal, a.nama_evaluasi, a.tahun_evaluasi FROM `evaluasi` a
            LEFT JOIN pertanyaan_umum b ON b.evaluasi_id = a.id
            WHERE a.id = $id");
        $user=request()->user();
